...
#Step 10 - Weighted DEA (custom weights)

# Define custom weights (example: emphasize new build and total contributions)
...
# Step 13 - Correlation Analysis (critical factors)
...
#Bar plot for trusts by eff category
